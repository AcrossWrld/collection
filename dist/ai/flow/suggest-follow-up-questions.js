...
exports.suggestFollowUpQuestion = void 0;
/**
...
var SuggestFollowUpInputSchema = genkit_2.z.object({
    pdfContent: genkit_2.z.string().describe('The content of the PDF document.'),
    lastUserQuestion: genkit_2.z.string().describe('The last question asked by the user.'),
    lastAiAnswer: genkit_2.z.string().describe('The last answer provided by the AI.'),
});
var SuggestFollowUpOutputSchema = genkit_2.z.object({
...
function suggestFollowUpQuestion(input) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, suggestFollowUpQuestionFlow(input)];
        });
    });
}
exports.suggestFollowUpQuestion = suggestFollowUpQuestion;
...
var suggestFollowUpQuestionFlow = genkit_1.ai.defineFlow({
...
//# sourceMappingURL=suggest-follow-up-questions.js.map