...
exports.evaluateQuizAnswer = void 0;
var genkit_1 = require("../genkit");
var genkit_2 = require("genkit");
var EvaluateQuizAnswerInputSchema = genkit_2.z.object({
    question: genkit_2.z.string().describe('The quiz question.'),
    userAnswer: genkit_2.z.string().describe('The user\u2019s answer to the question.'),
    correctAnswer: genkit_2.z.string().describe('The correct answer to the question.'),
});
var EvaluateQuizAnswerOutputSchema = genkit_2.z.object({
    isCorrect: genkit_2.z.boolean().describe('Whether the user answered the question correctly.'),
    correctAnswer: genkit_2.z.string().describe('The correct answer to the question.'),
    explanation: genkit_2.z
        .string()
        .describe('An explanation of why the user\u2019s answer was incorrect, if applicable.'),
});
function evaluateQuizAnswer(input) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, evaluateQuizAnswerFlow(input)];
        });
    });
}
...
var evaluateQuizAnswerFlow = genkit_1.ai.defineFlow({
...
//# sourceMappingURL=evaluate-quiz-answer.js.map